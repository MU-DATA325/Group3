...
```
--
Using these packages we can save the dataset using *<u>read_csv</u>* and later edit our tabels.
...
genre_globalsales %>%
  ...
  theme_minimal() +
  labs(
    title = "Video Game Genres Global Sales",
...
* Most popular video-game genre in Europe is 

--

* Most popular video-game genre in Japan is

--

* Most popular video-game genre in the USA is

--

* Most popular video-game genre in the world is 